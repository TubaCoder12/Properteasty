      ...
      <div className="flex flex-col items-center gap-[5px]">
        ...
        >
          ...
          <div
            ...
            style={{
              left: active === "self" ? "4px" : "219.5px", // smooth move
            }}
          ></div>
          ...
          <button
            ...
            className={`relative z-10 w-[210.5px] h-[32px] p-[4px] rounded-[8px] gap-[6px] transition-all duration-300
              ${
                active === "self"
        ...
        <div className="text-center mt-2 text-black/16 font-medium">
          {active === "self" && (
            <>
              <h2 className="text-7xl px-12 text-left leading-[72px] tracking-normal space-x-[6px] mb-12">
              ...
              <section className="px-4 md:px-12 py-6">
                <div className="grid md:grid-cols-2 gap-6">
                  {/* Self Management */}
                  <div className="bg-[#F6F7F9] px-6 pt-[44px] pb-[32px] rounded-[20px]">
                    <h2 className="text-5xl font-[500]  text-center">
                      Self Management
                    </h2>
                    <div className="space-y-4 py-[90px] ">
                 ...
                 text-[24px] group hover:bg-[#3CAB5C]"
                        >
                          ...
                          {/* Text */}
                          <p
                            className="text-2xl leading-[30px] tracking-normal space-x-[6px] text-left font-[500] 
                  ...
                  {/* With Properteasy */}
                  <div className="bg-[#3CAB5C] px-6 pt-[44px] pb-[32px] rounded-[20px]">
                   ...
                   transition-all duration-300 text-[24px] group hover:bg-white"
                        >
                          ...
                          {/* Text */}
                          <p
                            className="text-2xl leading-[30px] tracking-normal space-x-[6px] 
                      text-left font-[500] text-white group-hover:text-[#52C171]"
                          >
                            {item.text}
                          </p>
                        </div>

          ...
          <div className="w-full    pb-24">
           ...
           gap-3`}
            ...
            <p className="  py-12 md:px-12 px-4 text-[24px]  font-normal leading-9 tracking-normal space-x-[6px]">
              ...
              verification, as well as client reference validation. Only those
              who demonstrate consistent excellence and reliability are given
              the opportunity to serve our landlords and their tenants.
            </p>
            <p className=" text-[24px] md:px-12 px-4  font-normal leading-9 tracking-normal space-x-[6px]">
              Our screening process is hands on, ensuring only the most
              dependable, skilled, and trustworthy vendors make the cut. Our
              service providers are established local tradesmen with proven
              track records, the professionals you wish you had from the start.
              With Properteasy, now you do.
            </p>
          </div>
        </div>
      </section>

      ...
      <div className="lg:max-w-[1440px] w-full mx-auto">
        <div className="w-full    pb-24">
          ...
          <p className=" text-[24px] md:px-12 px-4  font-normal leading-9 tracking-normal space-x-[6px]">
            ...
            service providers are established local tradesmen with proven track
            records, the professionals you wish you had from the start. With
            Properteasy, now you do.
          </p>
        </div>
      </div>
    </>
